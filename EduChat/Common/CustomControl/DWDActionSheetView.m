...
#define kRowLineHeight          0.8
#define kDividerViewHeight      8.0

#define kTitleFontSize          SCREEN_ADJUST(15)
#define kButtonTitleFontSize    SCREEN_ADJUST(16)
...
@implementation DWDActionSheetView
