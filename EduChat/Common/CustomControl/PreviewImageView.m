...
//        
//        WEAKSELF;
//        UIAlertAction *savePicAction = [UIAlertAction actionWithTitle:@"保存图片" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
//            [weakSelf savePicActionClick:action];
//        }];
//        UIAlertAction *cancelAction = [UIAlertAction actionWithTitle:@"取消" style:UIAlertActionStyleCancel handler:nil];
//        [alertController addAction:savePicAction];
...
//
//- (void)savePicActionClick:(UIAlertAction *)action {
//    
