...
- (void)btnclick:(UIButton *)btn{
    if ([btn.titleLabel.text isEqualToString:@"成长记录"]) {
        DWDClassSourceGrowupRecordViewController *growupRecordVc = [[DWDClassSourceGrowupRecordViewController alloc] init];
        ...
        DWDClassSourceHomeWorkViewController *homeworkVc = [[DWDClassSourceHomeWorkViewController alloc] init];
        ...
        [_conversationVc.navigationController pushViewController:checkScoreVc animated:YES];
