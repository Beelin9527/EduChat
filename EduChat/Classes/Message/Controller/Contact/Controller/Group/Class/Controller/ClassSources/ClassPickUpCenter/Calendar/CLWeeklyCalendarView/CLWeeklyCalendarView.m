...
-(void)applyCustomDefaults
{
    ...
    DWDLog(@"%@  %f", attributes[CLCalendarBackgroundImageColor],  self.selectedDatePrintFontSize);
...
-(UIImageView *)backgroundImageView
{
    ...
    _backgroundImageView.backgroundColor = DWDRGBColor(90, 136, 231);//self.backgroundImageColor? self.backgroundImageColor : [UIColor colorWithPatternImage:[UIImage calendarBackgroundImage:self.bounds.size.height]];;
